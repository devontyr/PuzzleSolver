...
void interactivePiece::mouseReleaseEvent(QMouseEvent *evt) {
    ...
    const int snapRadius = 100; // like a threshhold for how far out a piece will snap
    const int pieceSize = 300; // replace with the piece's actual size (maybe plus a tiny bit of room)
